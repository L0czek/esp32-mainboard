...
async fn clock_task(motor_pin0: Motor0Pin, motor_pin1: Motor1Pin, power: PowerHandle) {
    ...
    let mut pin0 = Output::new(motor_pin0, pin0_state.into(), OutputConfig::default().with_drive_mode(esp_hal::gpio::DriveMode::PushPull));
    let mut pin1 = Output::new(motor_pin1, pin1_state.into(), OutputConfig::default().with_drive_mode(esp_hal::gpio::DriveMode::PushPull));
